...
source service.bat status_general.sh
source service.bat check_updates.sh
source service load_game_filter.sh
source service load_user_list.sh

BIN="/opt/general/bin"
LIST="/opt/general/list"
cd "$BIN" || exit 1

sudo /opt/zapret/bin/tpws \
  --wf-tcp=80,443,2053,2083,2087,2096,8443,$GameFilterTCP \
  --wf-udp=443,19294-192944,50000-50100,$GameFilterUDP \
